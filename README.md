...
Para compreender o fluxo de comunicação de Webhooks e como este motor atende clientes externos sem partilhar banco de dados, consulte nossa documentação global: [Relatório de Arquitetura Global](../protocolov/ARCHITECTURE.md).
