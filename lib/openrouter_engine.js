...
2. NUNCA repita os números brutos que já estão nos dados. O jogador já sabe o KDA, ADR e ACS dele. Sua função é CRUZAR as métricas e expor o que elas revelam em conjunto — contradições, padrões ocultos, falhas de execução tática.
