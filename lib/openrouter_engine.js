...
const FALLBACK_MODELS = [
    'google/gemini-2.0-flash-exp:free',       // Alta velocidade e precisão em JSON (Custo Zero)
    'meta-llama/llama-3.1-8b-instruct:free', // Muito estável e confiável (Custo Zero)
    'deepseek/deepseek-r1:free',             // Raciocínio profundo (Custo Zero)
    'mistralai/mistral-7b-instruct:free',    // Estabilidade e fluidez em PT-BR (Custo Zero)
    'microsoft/phi-3-medium-128k-instruct:free' // Excelente para análise (Custo Zero)
];
